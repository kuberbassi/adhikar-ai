...
router.post('/', async (req, res) => {
    const { userDetails, analysis, caseDetails } = req.body;
    ...
    // ──────────────────────────────────────────────
    const aiDraft = await generateDraft(userDetails, analysis, caseDetails);
    if (aiDraft) {
        console.log(`🤖 AI Draft generated (${aiDraft.length} chars)`);
    ...
    // ──────────────────────────────────────────────
    console.log('📋 Using template fallback for draft');
...
═══════════════════════════════════════════════════════
   This notice is generated by Adhikar.ai — AI Legal Assistant
