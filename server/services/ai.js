 ...
 */
async function generateDraft(userDetails, analysis, caseDetails, evidence = null) {
    if (!groq) return null;
...
CRITICAL RULES:
1. Only cite acts and sections from established Indian law. Do NOT fabricate any section numbers.
2. Use formal legal language throughout.
3. Do NOT use markdown formatting — output plain text only.
4. Use Unicode borders like ═══ and ─── for visual separation.
5. ALWAYS include the following disclaimer at the very end:
...
6. BODY with sections:
   ...
   - Consequence of Non-Compliance (Standard legal warning: "my client will be compelled to initiate appropriate civil/consumer proceedings against you". 15-day deadline. Seek damages/compensation. DO NOT threaten specific imprisonment terms unless citing a relevant criminal section.)
7. Signature block
